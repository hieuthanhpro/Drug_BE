    ...
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <div class="card-body ">
                ...
                <form method="post" class="card-body row" action="{{route('admin.linkads.create')}}">
                    @csrf
                    <div class="col-lg-6 p-t-20">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" type="text" id="txtDepName" name="text" placeholder="Nội dung"  value="">
                        </div>
                    </div>
                    <div class="col-lg-6 p-t-20">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" type="text" id="txtDepHead" name="link" placeholder="Đường dẫn"  value="">
                        </div>
                    </div>
